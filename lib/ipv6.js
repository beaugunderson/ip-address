 ...
 * @example
 * var address = Address6.fromURL('http://[ffff::]:8080/foo/');
 */
 ...
 */
Address6.compact = function (address, slice) {
  var s1 = [];
  var s2 = [];
  var i;
 ...
 * @returns {string}
 */
Address6.prototype.reverseForm = function () {
...
Address6.prototype.correctForm = function () {
  ...
  if (zeroes.length > 0) {
    ...
    groups = Address6.compact(this.parsedAddress, zeroes[index]);
  } else {
 ...
 * @returns {string}
 */
Address6.prototype.v4inv6 = function () {
  var binary = this.binaryZeroPad().split('');

  var address4 = Address4.fromHex(new BigInteger(binary.slice(96, 128)
    .join(''), 2).toString(16));
 ...
 * @returns {Object}
 */
Address6.prototype.teredo = function () {
  /*
 ...
 * @returns {Object}
 */
Address6.prototype.six2four = function () {
  /*
 ...
 * @returns {Address6}
 */
Address6.prototype.get6to4 = function () {
  if (!this.is4()) {
    return null;
  }
