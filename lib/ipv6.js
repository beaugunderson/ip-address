...
_.merge(v6, require('./v6/constants.js'));
...
_.merge(v6.Address.prototype, require('./v6/attributes.js'));
_.merge(v6.Address.prototype, require('./v6/html.js'));
_.merge(v6.Address.prototype, require('./v6/regular-expressions.js'));
