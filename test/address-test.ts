...
function loadJSON(path: string) {
  return JSON.parse(
    Buffer.from(
      fs.readFileSync(
        // import.meta.url in ES Modules is equivalent to __dirname in CommonJS
...
const invalid4 = loadJSON("./data/invalid-ipv4-addresses.json");
const invalid6 = loadJSON("./data/invalid-ipv6-addresses.json");

const valid4 = loadJSON("./data/valid-ipv4-addresses.json");
const valid6 = loadJSON("./data/valid-ipv6-addresses.json");
